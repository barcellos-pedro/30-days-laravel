<x-layout>
    ...
    <form method="POST" action="/jobs/{{ $job->id }}">
                ...
                <div class="mt-10 grid grid-cols-1 gap-x-6 gap-y-8 sm:grid-cols-6">
                    <div class="sm:col-span-4">
                        ...
                        <div class="mt-2">
                            ...
                            @error('title')
                            <p class="text-sm text-red-500 font-bold mt-2">{{ $message }}</p>
                            @enderror
                        </div>
                    </div>
        ...
        <div class="flex justify-between items-center mt-6">
            <div>
                <button form="delete-form" type="submit" class="rounded-md bg-red-600 px-3 py-2 text-sm font-semibold text-white shadow-sm hover:bg-red-700">
                    Delete
                </button>
            </div>
