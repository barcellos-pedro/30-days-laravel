...
Route::get('/test', function () {
    // defer closure to run outside the current request (async)
    // depends on 'php artisan queue:work'
//    dispatch(function () {
//        logger('hello from the queue!');
//    })->delay(5); // delay is optional

    // Using dedicated Job 'php artisan make:job'
    $job = Job::first();
